...
*/
Vue.component("simple_cta_component_1723782550", {
    template: `
        ...
        <div id="cta-inner-container" class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Stay ahead of the curve with real-time updates on new blockchain developments, projects, and innovations.</p>
                </div>
                
                <div id="cta-image-container" class="flex justify-center mb-6">
                    <img id="cta-image" src="https://raw.githubusercontent.com/56b81caaa87941618cfed6dfb4d34047/Blockchain_Info_Finder_1723782547/main/images/5470fdbfc8e14a178bd62e20ecfcfa48.jpeg" alt="Blockchain Updates" class="max-w-full h-auto">
                </div>
